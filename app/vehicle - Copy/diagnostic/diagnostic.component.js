...
var DiagnosticComponent = (function () {
    function DiagnosticComponent(_router) {
        this._router = _router;
        this.title = 'Vehicle Diagnostic';
    }
    DiagnosticComponent.prototype.getModule = function (modulename) {
        if (modulename == 'info') {
